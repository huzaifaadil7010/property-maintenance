...
class CreateResident
{
    ...
    private static function createResidentUser(ResidentData $data, string $temporaryPassword): User
    {
        return CreateUser::handle(new ResidentUserData(
            name: $data->name,
            email: $data->email,
    ...
    private static function configureResident(User $resident, Organization $organization): void
    {
    ...
    private static function createResidentOccupancy(
        User $resident,
        Unit $unit,
        Organization $organization,
    ): Occupancy {
        return CreateOccupancy::handle(new OccupancyData(
    ...
    private static function registerAccountNotification(User $resident, string $temporaryPassword): void
    {
